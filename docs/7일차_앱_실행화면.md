...
> 각 항목의 화면을 캡처해 아래 이미지 자리에 넣는다.
> (마크다운 이미지 문법: `![설명](images/파일명.png)`)
...
<!-- ![예측 진행 중](images/7일차_predict_loading.png) -->
![예측 결과 표시 (진료 상세 + X-ray + 예측 결과)](images/7일차_predict_result.png)
